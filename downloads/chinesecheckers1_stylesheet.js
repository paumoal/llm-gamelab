...
function color (cell,state)
 {var color = compfindx('Z',seq('cell',cell,'Z'),state,seq());
  if (color=='red') {return '<img src="../library/chinesecheckers3/red.png" width="40" height="40"/>'};
  if (color=='green') {return '<img src="../library/chinesecheckers3/green.png" width="40" height="40"/>'};
  if (color=='blue') {return '<img src="../library/chinesecheckers3/blue.png" width="40" height="40"/>'};
  return '<img src="../library/chinesecheckers3/black.png" width="40" height="40"/>'}
